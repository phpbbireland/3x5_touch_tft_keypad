...
The ***alt*** folder containg current code used during my latest tests. I has removed unnecessary code. If anyone wants to help find Stack issue, check out this code...
